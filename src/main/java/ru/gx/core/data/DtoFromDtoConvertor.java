...
public interface DtoFromDtoConvertor<DEST extends DataObject, SRC extends DataObject> {
     ...
     */
    void fillDtoCollectionFromSource(@NotNull final Collection<DEST> destination, @NotNull final Iterable<SRC> source) throws NotAllowedObjectUpdateException;
}
