...
import ru.gxfin.common.annotations.UpdatableValue;
...
/**
 * Тестовый клас для {@link UpdatableMemberInfoExtractor}
 *
 * @author Adolin Negash 18.05.2021
 */
class UpdatableMemberInfoExtractorTest extends AbstractMockTest {
    ...
    private final UpdatableMemberInfoExtractor infoExtractor = new UpdatableMemberInfoExtractor();
